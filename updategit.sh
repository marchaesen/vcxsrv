...
../vcxsrv.released/synchronise.py -e putty ../vcxsrv.released/tools/plink --skip-dir=windows --skip-dir=unix --skip-dir=contrib --skip-dir=doc --skip-dir=icons --skip-dir=macosx --skip-dir=testdata --skip-dir charset --skip-file=.gitignore --skip-file=Buildscr --skip-file=Buildscr.cv --skip-file=CHECKLST.txt --skip-file=LATEST.VER --skip-file=LICENCE --skip-file=README --skip-file=Recipe --skip-file=be_all_s.c --skip-file=be_none.c --skip-file=be_nos_s.c --skip-file=be_nossh.c --skip-file=be_ssh.c --skip-file=cmdgen.c --skip-file=config.c --skip-file=configure.ac --skip-file=dialog.c --skip-file=dialog.h --skip-file=import.c --skip-file=int64.c --skip-file=ldiscucs.c --skip-file=minibidi.c --skip-file=mkauto.sh --skip-file=mkfiles.pl --skip-file=mksrcarc.sh --skip-file=mkunxarc.sh --skip-file=nocproxy.c --skip-file=nogss.c --skip-file=noprint.c --skip-file=noshare.c --skip-file=notiming.c --skip-file=pageant.c --skip-file=pageant.h --skip-file=pproxy.c --skip-file=pscp.c --skip-file=psftp.c --skip-file=psftp.h --skip-file=resource.h --skip-file=sercfg.c --skip-file=sftp.c --skip-file=sftp.h --skip-file=sign.sh --skip-file=sshbcrypt.c --skip-file=sshdssg.c --skip-file=sshecdsag.c --skip-file=sshnogss.c --skip-file=sshprime.c --skip-file=sshrsag.c --skip-file=terminal.c --skip-file=testback.c --skip-file=wcwidth.c --skip-file=fuzzterm.c --skip-file=release.pl --skip-file=cgtest.c
