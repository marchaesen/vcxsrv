...
m4_define([b4_parser_base_class],
          [b4_percent_define_get([[api.parser.base.class]])])

m4_define([b4_parser_class_constructor_init],
          [b4_percent_define_get([[api.parser.class.constructor_init]])])

m4_define([b4_parser_class_constructor_param],
          [b4_percent_define_get([[api.parser.class.constructor_param]])])
...
# include <vector>
  ...
  /// A Bison parser.
  class ]b4_parser_class[ : public ]b4_parser_base_class[
  {
  public:
...
#define YYRECOVERING()  (!!yyerrstatus_)
  ...
  /// Build a parser object.
  ]b4_parser_class::b4_parser_class[ (]b4_parse_param_decl[ ]b4_parser_class_constructor_param[) ]b4_parser_class_constructor_init[ 
#if ]b4_api_PREFIX[DEBUG
    : yydebug_ (false),
