...
; The file to write
OutFile "vcxsrv-64-debug.1.18.1.1.installer.exe"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "1.18.1.1"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "1.18.1.1"
