...
; The file to write
OutFile "vcxsrv-64-debug.1.18.1.0.installer.exe"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "1.18.1.0"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "1.18.1.0"
