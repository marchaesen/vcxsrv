...
; The file to write
OutFile "vcxsrv-64-debug.1.17.5.0.installer.exe"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "1.17.5.0"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "1.17.5.0"
